    ...
    try {
        ...
        res.json({
            ...
            user: {
                ...
                bank_qr_code: user.bank_qr_code,
                cv_document: user.cv_document,
                id_card_document: user.id_card_document,
                shift_id: user.shift_id,
                off_day: user.off_day,
                break_time: user.break_time,
                annual_leave_total: user.annual_leave_total,
                annual_leave_used: user.annual_leave_used,
                resigned_reason: user.resigned_reason,
...
// Get Current User (Me) - Returns full employee data for session refresh
router.get('/me', authenticateToken, async (req, res) => {
    try {
        ...
        // Return ALL fields needed by the frontend mapEmployee function
        const mappedUser = {
            id: user.id,
            name: user.name,
            role: user.role,
