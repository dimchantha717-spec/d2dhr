...
db.query('ALTER TABLE employees ADD COLUMN IF NOT EXISTS created_by VARCHAR(100) DEFAULT NULL').catch(() => {});
db.query('ALTER TABLE employees ADD COLUMN IF NOT EXISTS changed_by VARCHAR(100) DEFAULT NULL').catch(() => {});
db.query('ALTER TABLE employees ADD COLUMN IF NOT EXISTS resigned_reason TEXT DEFAULT NULL').catch(() => {});
